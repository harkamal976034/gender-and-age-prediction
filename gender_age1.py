# Execute the following command to detect from image: python gender_age1.py -i 1.jpg  
# Execute the following command to detect from webcam: python gender_age1.py
...
parser.add_argument("-i", help='Path to input image or video file.')
